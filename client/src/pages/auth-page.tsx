...
import { Loader2, Mail, Lock, User, LogIn, Ticket, Eye, EyeOff } from "lucide-react";
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="pl-10 pr-10 py-6 h-12 bg-[#f8f5f0] border-[#e8d9c5] focus-visible:ring-[#16213e]"
                            placeholder="••••••••"
                            {...field}
                          />
                          <button
